...
// Function for setting a random song
  ...
  if (random == 1) {
    ...
    songname.innerHTML = "YUNG ADISZ - CZAS MI MIJA";
  }
  else if (random == 2) {
    document.getElementById("loading").src = "song/song2.mp3";
    songname.innerHTML = "Otsochodzi - BLOK!";
  }
  else if (random == 3) {
    document.getElementById("loading").src = "song/song3.mp3";
    songname.innerHTML = "Malik Montana x Lil Tjay - Samolotowy tryb";
  }
  else if (random == 4) {
    document.getElementById("loading").src = "song/song4.mp3";
    songname.innerHTML = "BEZBEZ";
  }
  else if (random == 6) {
    document.getElementById("loading").src = "song/song5.mp3";
    songname.innerHTML = "Waima - RING RING";
  }
  else if (random == 7) {
    document.getElementById("loading").src = "song/song6.mp3";
    songname.innerHTML = "Bonus RPK ft. Paluch x Dj Steez - KALKULATOR";
  }
